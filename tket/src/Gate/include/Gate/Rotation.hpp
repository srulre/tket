...
class Rotation {
 public:
   ...
   */
  Rotation(OpType optype, symbol::Expr a);
   ...
   */
  std::optional<symbol::Expr> angle(OpType optype) const;
   ...
   * @pre p != q
   */
  std::tuple<symbol::Expr, symbol::Expr, symbol::Expr> to_pqp(
 ...
 private:
  ...
  symbol::Expr s_;  // scalar
  symbol::Expr i_;  // i coordinate
  symbol::Expr j_;  // j coordinate
  symbol::Expr k_;  // k coordinate
